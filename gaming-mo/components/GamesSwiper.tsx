...
const GamesSwiper = ({
  ...
  if (isLoading) {
    return (
      <div>
        <h1 className="mt-8 text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-purple-500">
          {title}
        </h1>
  ...
  if (!games || games.length === 0) {
    return (
      <div className="mt-8">
        ...
        <div className="mt-8 p-4 rounded-lg backdrop-blur-lg bg-gradient-to-br from-red-500/10 to-purple-500/10">
          <p className="text-gray-400 text-center">No games available at the moment</p>
        </div>
      </div>
    );
  }
        ...
        >
          ...
          <div className="flex-shrink-0 transform perspective-1000">
            ...
            <Button
              ...
              className="mt-4 w-full transition-all duration-300 bg-purple-500/20 hover:bg-purple-500/30 text-purple-400"
            >
          ...
          <div className="flex flex-col md:ml-8 mt-6 md:mt-0 max-w-xl">
            ...
            <div className="h-1 w-20 bg-gradient-to-r from-red-500 to-purple-500 rounded-full mt-4 self-start" />
          </div>
        </div>
      );
    }
